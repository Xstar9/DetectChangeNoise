...
//    public static String commitListPath = projectLocalPath + currentDir + "commitList.csv";
    ...
    private static final String error_trans_file = trans_commits_report_dir + "trans-error-lists.csv";
    private static final String success_trans_file = trans_commits_report_dir + "trans-commits-datasets1.csv";
...
//        currentDir = "webmagic";//"spring-hateoas";
            String localPath = "E:\\project-DataSets1\\" + currentDir;
...
//                writeCloneErrorToCSV("D:\\JavaProject\\SPAT\\local_project_list.csv", new String[]{gitRepositoryPath,localPath});
                writeCloneErrorToCSV(trans_commits_report_dir+"clone_fail_projects2.csv",new String[]{gitRepositoryPath});
                continue;
            }
...
//            try {
            ...
            if (new File(getOutputPath(filePath, dirPath, outputDir)).exists()
                    && !readFile(getOutputPath(filePath, dirPath, outputDir)).isEmpty()) {
                isHasChange = true;
                break;
            }
    ...
    public static void writeDataToCSV(String filePath, String[] data) {
        ...
        try {
            ...
            if (!fileExists) {
                ...
                String[] header = {"id", "projectName", "startCommit", "endCommit", "transformType","transformTypeId", "transformSum", "RelatedMethodsNum","RelatedMethodSet"};
