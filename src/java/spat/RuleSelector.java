...
public class RuleSelector {
	...
	static final int Case2ForForEach = 18; // new add
	...
	static final int TRANSFORM_FREQUENCY = 1; // 至多转换的次数
	...
	static ASTVisitor create(String ruleId, CompilationUnit cu_, Document document_, String outputDirPath_) {
		...
		case Case2ForForEach:
			return new ChangeFor2ForEach(cu_, document_, outputDirPath_);
